...
export class AuthService {
  ...
  async validate(email: string, password: string) {
    ...
    console.log(user.password,"sjhgfdhjasg")
    if (!user) {
      //  console.log("sajdfhjakh kjdsgh")
      return null; 
    }
    const paswordStatus =await this.checkHash(password, user.password);
    console.log(paswordStatus,"ahjsg jshg");
    if (paswordStatus){
